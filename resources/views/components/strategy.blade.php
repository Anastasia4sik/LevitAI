<section class="strategy" @if(request()->is('roadmap'))
  style="
    ...
    <div class="strategy__content__list">
      ...
      <div class="strategy__content__list__item">
        ...
        <div class="strategy__content__list__item__line">
          <div
            class="strategy__content__list__item__line__color strategy__content__list__item__line__color--{{ $item['percentage'] }}">
          </div>
        </div>
      </div>
      @endforeach
