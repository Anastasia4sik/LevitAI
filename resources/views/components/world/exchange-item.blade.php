...
<x-base>
  <section class="item">
    ...
    <div class="item__container">
      <div class="item__container__content d-flex">
        <div class="item__container__content__text">
            ...
            <div class="item__container__content__nft__mob-block">
                <img src="{{ asset('src/img/photo/nft/nft2.jpg')}}" alt="Nft" class="item__container__content__nft__mob">
            </div>

            <div class="item__container__content__text__user__block">
                <div class="item__container__content__text__user d-flex flex-row align-items-center">
                    <img src="{{ asset('src/img/photo/nft/user1.jpg')}}" alt="User photo"
        ...
        <div class="item__container__content__info">
            ...
            <div class="qna__block__content__list">
                ...
                <div class="qna__block__content__list__group qna__block__content__list--general">
                    <div class="item__container__content__info__list__item">
                    <img src="{{ asset('src/img/exchange-graph.png')}}" alt="Graph"
                    ...
                    <a
                        ...
                        class="
                            complete__btn
                            item__container__content__info__list__item__row__btn
                            d-flex
                            flex-row
                            align-items-center
                            button
        ...
        <div class="item__container__content__text__user__block--mob">
            <div class="item__container__content__text__user d-flex flex-row align-items-center">
                <img src="{{ asset('src/img/photo/nft/user1.jpg')}}" alt="User photo"
                class="item__container__content__text__user__photo">
      ...
      <div class="item__container__slides">
        ...
        <div class="item__container__slides__row d-flex">
          <h2 class="item__container__slides__title title-main title-main--stroke">
            collection
          </h2>

          <a href="/exchange-market" class="
                                complete__btn
                                d-flex
                                flex-row
                                align-items-center
