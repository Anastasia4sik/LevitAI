    ...
    <section class="discover__article">
      ...
      <div
        ...
        <div class="discover__article__content__text">
          <p class="discover__article__content__text__desc desc">
            ...
            <br><br>
            From the underlying algorithms and tech infrastructure through to our hardware partners, we do not make any
            compromises as far as the creation of the best future proofed metaverse is concerned.
          </p>
      ...
      <div
        ...
        <div class="discover__article__content__text discover__article__content__text--integrations">
          ...
          <p class="discover__article__content__text__desc desc">
            Using cutting edge technology from Unreal Engine, we have been able to create life-like 3D avatars never
            seen before in any other VR world experience.
            <br><br>
