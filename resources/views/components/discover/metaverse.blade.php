  ...
  <section class="discover">
    ...
    <section class="discover__article">
      ...
      <div
        ...
        <div class="discover__article__content__text">
          <h3 class="discover__article__content__text__title title-little">
            The first ever fully immersive virtual world giving ‘citizens’ no limits, realistic and boundless
            experience.
          </h3>
          ...
          <p class="discover__article__content__text__desc desc">
            ...
            <br><br>
            Using the world’s leading 3D rendering software from Unreal Engine, we will create the best user experience
            allowing you to design, create, build and trade in a metaverse that is constantly evolving.
            <br><br>
            Key Highlights
            <br><br>
            &ensp;&#x2022; Play games and Complete quests
            <br>
            &ensp;&#x2022; Buy and Sell goods & services
            <br>
            &ensp;&#x2022; Attend classes and lectures
            <br>
            &ensp;&#x2022; Visit virtual galleries
            <br>
            &ensp;&#x2022; Watch sporting events
            <br>
            &ensp;&#x2022; Create your own games and quests
            <br>
            &ensp;&#x2022; Explore a world full of adventures and user content
            <br>
            &ensp;&#x2022; Get rewarded for everything you do
          </p>
        </div>
      </div>
      ...
      <div class="metaverse__article__content">
        <h3 class="discover__article__content__text__title title-little">
          Victoria VR is introducing a cutting-edge realistic reality which will attract a broad audience across diverse
