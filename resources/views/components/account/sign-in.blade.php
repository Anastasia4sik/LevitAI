<x-base>
  <section class="register">
    ...
    <div class="register__container register__container--signin d-flex">
      ...
      <form action="#" class="register__container__form signIn__container__form">
        <div class="register__container__form__inputs gap-0 d-flex flex-column">
          <label for="signinLogin" class="register__container__form__label title-little">
            Login
          </label>
        ...
        <a href="/register" class="register__container__form__link desc">
          Registration
        </a>
      </form>
    </div>
