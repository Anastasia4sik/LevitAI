...
<x-base>
    <section class="wallet">
        ...
        <div class="wallet__content d-flex">
            ...
            <div class="wallet__content__big d-flex">
                ...
                <div class="wallet__content__info wallet__content__info--mob">
                    <div class="wallet__content__info__top d-flex flex-row justify-content-between">
                        <div class="wallet__content__info__top__transactions d-flex flex-column">
                            <p class="wallet__content__info__top__transactions__nums title-little">
                                2.354
    ...
    <script>
        const walletsListItems = document.querySelectorAll('.wallet__content__wallets__list__item');

        walletsListItems.forEach((item) => {
            item.addEventListener('click', () => {
                walletsListItems.forEach((otherItem) => {
