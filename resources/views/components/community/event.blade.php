  ...
  <section class="event">
    ...
    <section class="article">
      ...
      <div class="article__content d-flex flex-row justify-content-between align-items-center">
        <img src="{{ asset('src/img/photo/blog.jpg')}}" alt="Cryptocash Is A Clean & Modern Coin Service - Levitai"
          class="article__content__img">

        <div class="article__content__text">
          <p class="article__content__text__desc desc">
          ...
          <h3 class="article__content__text__title title-little">
            Cryptocash Is A Clean & Modern Coin Service - Levitai
          </h3>
          ...
          <p class="article__content__text__desc desc">
            ...
            magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
            commodo consequat. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
            labore dolore magna Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
            incididunt labore dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
          </p>
        </div>
      </div>
