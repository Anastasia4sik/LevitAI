...
<x-base>
  <section class="teamPage">
    ...
    <section class="teamPage__top topPage d-flex flex-column align-items-center justify-content-center">
      <div class="
    ...
    <section class="teamPage__experts">
    ...
    <section class="teamPage__advisor">
      ...
      <div class="teamPage__advisor__swiper swiper-container">
        <div class="swiper-wrapper">
          @foreach($teamInfo as $key => $item)
          <div class="teamPage__advisor__swiper__card swiper-slide">
            <img src="{{ asset($item['photo'])}}" alt="Expert Team Member" class="teamPage__advisor__swiper__card__img">

            <h3 class="teamPage__advisor__swiper__card__name title-little">
              {{ $item['name'] }}
            </h3>

            <p class="teamPage__advisor__swiper__card__position title-little">
              {{ $item['position'] }}
            </p>

            <p class="teamPage__advisor__swiper__card__desc desc">
              {{ $item['desc'] }}
            </p>

            <div class="teamPage__advisor__swiper__card__btns d-flex flex-row align-items-center">
              <a href="mailto:{{ $item['mail']}}" class="
                                        complete__btn
                                        d-flex
                                        flex-row
              ...
              <a href="{{ $item['twitter'] }}" target="_blank" class="teamPage__advisor__swiper__card__btns__item">
                <img src="{{ asset('src/img/icons/media/twitter.png')}}" alt="Twitter">
              </a>

              <a href="{{ $item['pinterest'] }}" target="_blank" class="teamPage__advisor__swiper__card__btns__item">
                <img src="{{ asset('src/img/icons/media/pinterest.png')}}" alt="Pinterest">
              </a>
            </div>
          </div>
