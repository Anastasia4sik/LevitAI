            ...
            <div id="contact-form" class="contactPage__bottom d-flex flex-row align-items-end justify-content-between">
                <div class="contactPage__bottom__left d-flex flex-column">
                    ...
                    <div class="contactPage__bottom__left__text d-flex flex-row align-items-center">
                        ...
                        <div class="contactPage__bottom__left__text__media d-flex flex-row align-items-center justify-content-between">
                            <div class="contactPage__bottom__left__text__media__column d-flex flex-column">
                                <a href="https://maps.app.goo.gl/Jm7MvvY67aTJmciKA" class="contactPage__bottom__left__text__media__column__desc d-flex flex-row align-items-center" target="_blank">
                                ...
                                <a href="https://www.levitai.com" class="contactPage__bottom__left__text__media__column__desc d-flex flex-row align-items-center" target="_blank">
                                ...
                                <a href="mailto:LevitAI@gmail.com" class="contactPage__bottom__left__text__media__column__desc d-flex flex-row align-items-center" target="_blank">
                            ...
                            <div class="contactPage__bottom__left__text__media__column d-flex flex-column">
                                <a href="Tel:+13058995577" class="contactPage__bottom__left__text__media__column__desc d-flex flex-row align-items-center">
                                ...
                                <a href="Tel:+13058995100" class="contactPage__bottom__left__text__media__column__desc d-flex flex-row align-items-center">
                                ...
                                <a href="https://t.me/snoopwest" class="contactPage__bottom__left__text__media__column__desc d-flex flex-row align-items-center" target="_blank">
                    ...
                    <form action="#" class="contactPage__form d-flex flex-column">
                        <div class="contactPage__form__group d-flex flex-row align-items-row">
                            <input type="text" placeholder="Name" name="Name" class="contactPage__form__input contact__form__group__input">

                            <input type="email" placeholder="Email" name="Email" class="contactPage__form__input contact__form__group__input">
                        </div>

                        <div class="contactPage__form__group d-flex flex-row align-items-row">
                            <input type="phone" placeholder="Number" name="Number" class="contactPage__form__input contact__form__group__input">

                            <input type="url" placeholder="Website" name="Website" class="contactPage__form__input contact__form__group__input">
                        </div>
