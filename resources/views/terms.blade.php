<x-base>
    <section class="terms">
        ...
        <div class="terms__text">
            <h2 class="terms__title title-main">
                Terms of use
            </h2>

            <h3 class="terms__title-sec title-little">
                INTRODUCTION
            </h3>

            <p class="terms__desc desc">
            ...
            <p class="terms__desc desc">
                ...
                <br>
                <br>
                &#x2022;    do not share, rent, resell, or make available copies of the Game (or any ‘hacked’ versions) or otherwise use the Game or our websites commercially in any way except as expressly per-mitted by law (such as under ‘fair dealing or ‘fair use’ laws);
                <br>
                &#x2022;    do not cheat, rig, fix, circumvent rules or processes, use multiple accounts, exploit ‘loop-holes’ or bugs, or use our Games or websites in a way which is not within the spirit intended by our T&Cs or in a way which may harm the experience of other users of the Games and websites;
                <br>
                &#x2022;    do not modify or adapt the Game or our websites or hack, merge, translate, creative deriva-tives from the Game or our websites, mimic, disable the Game or our websites or tamper with them;
                <br>
                &#x2022;    do not make public or commercial use, by any means, of any Game or our websites, products or services without our prior written consent;
                ...
                <br>
                &#x2022;    do not reverse engineer, decompile, disassemble, decipher or otherwise attempt to derive the source code for any underlying software or other intellectual property used to provide the Game or our websites;
                <br>
                &#x2022;    where applicable, do not share any password or security information you use to access the Game or our websites with any other person;
                <br>
                &#x2022;    do not delete, obscure, remove or otherwise prevent the proper display of intellectual prop-erty (including without limitation copyright and trade mark notices or other legal lines or credits) notices in our Games or websites;
                <br>
                &#x2022;    do not do anything (or attempt to do anything) which might disrupt use of the Game or web-sites by us or other users, or which could threaten, harass or upset other users of the Game or website community; and
                <br>
                &#x2022;    do not make anything available on or through the Game or our websites that violates the rights of third parties (including without limitation their intellectual property or privacy rights).
                <br>
                <br>
            ...
            <h3 class="terms__title-sec title-little">
                THIRD PARTY CONTENT IN OUR GAMES & WEBSITES
            </h3>
            ...
            <p class="terms__desc desc">
                ...
                <br>
                &#x2022;    does not include any virus, worm, logic bomb, bug or any other form of malicious or techni-cally harmful data, code, link or information;
                <br>
            ...
            <h3 class="terms__title-sec title-little">
                PLEASE READ THIS NOTICE BEFORE YOU USE OUR GAMES
            </h3>
            ...
            <h3 class="terms__title-sec title-little">
                PLEASE FOLLOW THESE PRECAUTIONS WHENEVER USING A GAME WITH VR EQUIPMENT:
            </h3>
            ...
            <p class="terms__desc desc">
                ...
                <br>
                <br>
                &#x2022;    only play a Game with VR equipment (including VR headsets and sensors) in a safe environ-ment;
                <br>
                &#x2022;    be aware of your surroundings before playing a Game with VR equipment;
                <br>
                &#x2022;    do not use a VR headset and/or VR hardware, if you are sick, sleep, or feel tired, fatigue or discomfort, under the influence of alcohol or drugs, or hung-over;
                <br>
            ...
            <p class="terms__desc desc">
                ...
                <br>
                &#x2022;    if we can’t fix that fault within a reasonable time, or without significant inconvenience, you’re entitled to all or some of your money back that you paid to use the Game (where applicable); and
                <br>
